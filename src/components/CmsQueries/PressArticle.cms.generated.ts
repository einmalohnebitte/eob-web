...
export type PressArticleQuery = { __typename?: 'Query', pressArticles: Array<{ __typename?: 'PressArticle', title?: string | null, content?: { __typename?: 'PressArticleContentRichText', html: string } | null }>, translations: Array<{ __typename?: 'Translation', locale: Types.Locale, key: string, value?: string | null }> };
