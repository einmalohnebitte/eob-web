...
export type FaqsQuery = { __typename?: 'Query', faqs: Array<{ __typename?: 'Faq', question: string, answer?: Types.Maybe<{ __typename?: 'RichText', html: string }> }>, translations: Array<{ __typename?: 'Translation', locale: Types.Locale, key: string, value?: Types.Maybe<string> }> };
