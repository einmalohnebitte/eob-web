...
export type FaqsQuery = { __typename?: 'Query', faqs: Array<{ __typename?: 'Faq', question: string, answer?: { __typename?: 'RichText', html: string } | null | undefined }>, translations: Array<{ __typename?: 'Translation', locale: Types.Locale, key: string, value?: string | null | undefined }> };
