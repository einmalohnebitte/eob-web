...
export type ShopsNumberQuery = { __typename?: 'Query', shopsConnection: { __typename?: 'ShopConnection', aggregate: { __typename?: 'Aggregate', count: number } }, kpis: Array<{ __typename?: 'Kpi', text?: string | null | undefined, value?: number | null | undefined }> };
