...
export type CityPartnersQuery = { __typename?: 'Query', cityPartners: Array<{ __typename?: 'CityPartner', link?: string | null, name?: string | null, logo?: { __typename?: 'Asset', url: string } | null }> };
