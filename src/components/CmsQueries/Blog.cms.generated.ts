...
export type BlogsQuery = { __typename?: "Query" } & {
  blogs: Array<
    { __typename?: "Blog" } & Pick<Types.Blog, "title" | "date" | "abstract">
  >;
...
export type BlogQuery = { __typename?: "Query" } & {
  blogs: Array<
    { __typename?: "Blog" } & Pick<Types.Blog, "title" | "date"> & {
        content?: Types.Maybe<
...
export const BlogsDocument: DocumentNode<BlogsQuery, BlogsQueryVariables> = {
  kind: "Document",
  definitions: [
    {
...
export const BlogDocument: DocumentNode<BlogQuery, BlogQueryVariables> = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
