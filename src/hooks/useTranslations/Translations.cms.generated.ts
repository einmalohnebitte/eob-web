...
export type TranslationsQuery = { __typename?: 'Query', translations: Array<{ __typename?: 'Translation', locale: Types.Locale, key: string, value?: Types.Maybe<string> }> };

export type TranslationsFragment = { __typename?: 'Translation', locale: Types.Locale, key: string, value?: Types.Maybe<string> };
